                ...
                <div className="tab-pane active show" id="tab-1">
                  <div className="row">
                    <div className="col-lg-8 details order-2 order-lg-1">
                      ...
                      <p className="font-italic">Special Items will be displayed here for the Buyer so that he/she know which items is most liked by people</p>
                      <p>It Will be based one of the most sold item. The item which is ordered the most will be displayed here so that the buyer knows which is the top rated item </p>
                    </div>
