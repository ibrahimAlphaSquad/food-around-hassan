    ...
    <div>
      <div>
          ...
          <div className="container d-flex">
            <div className="contact-info mr-auto">
              <span className="d-none d-lg-inline-block">
                <i className="icofont-clock-time icofont-rotate-180" /> Mon-Sat:
                11:00 AM - 23:00 PM
              </span>
            </div>
            ...
            <nav className="nav-menu d-none d-lg-block">
              <ul>
                ...
                <li className="book-a-table text-center">
                  <Link to={"/register"}>Register Your Self</Link>
                </li>
                <li className="book-a-table text-center">
        ...
        <div style={{ height: "100vh", width: "100%" }}>
          <GoogleMapReact
            bootstrapURLKeys={{
              key: "AIzaSyCo2LPH3BJbSjKpMdlgYVlXN6-SKrfO9oc",
            }}
          ...
          >
            <div className="row">
              <div className="col-lg-8">
                <h1>
                  Welcome to <span>Khansaama</span>
                </h1>
              ...
              <div className="row">
                ...
                <div className="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content text-white">
                  ...
                  <p className="font-italic text-white">
                    You can Find alot of interesting features through our
                    platform from searching food to ordering your favourite
                    foods. Finding Chefs whom you like and so more. You can also
                    start your own business if you thought that you are a goo
                    chef
                  </p>
                  <ul>
                    <li>
                      <i className="icofont-check-circled" /> Search For Chefs
                      and Their foods
                    </li>
                    <li>
                      <i className="icofont-check-circled" /> Order your
                      favourite food.
                    </li>
                    <li>
                  ...
                  <p>
                    This Platform will help both sets of people, the one looking
                    for tasty homemade food and the one who want to sell the
                    food at which they are good at making
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="footer-top">
            <div className="container">
              <div className="row">
                ...
                <div className="col-lg-4 col-md-6 footer-newsletter"></div>
              </div>
            </div>
          </div>
          <div className="container">
